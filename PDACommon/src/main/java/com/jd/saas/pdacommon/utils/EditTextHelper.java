...
public enum EditTextHelper {
     ...
     * 限制输入多位小数
     */
    public void limitDecimalPlaces(int num, @NonNull final EditText... editTexts) {
        for (EditText editText : editTexts) {
            editTextLimitDecimalPlaces(num, editText);
        }
    }
     ...
     * 限制输入两位小数
     */
    private void editTextLimitDecimalPlaces(final int num, @NonNull final EditText editText) {
