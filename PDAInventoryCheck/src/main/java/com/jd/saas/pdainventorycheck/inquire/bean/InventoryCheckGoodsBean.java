 ...
 * @date: 2021/6/17
 */
public class InventoryCheckGoodsBean implements Serializable {

    private static final long serialVersionUID = 3134785009529093789L;
    private int storeId;
    ...
    public static class FinanceBean implements Serializable {
        private static final long serialVersionUID = -3237016794051908041L;
        private double taxRate;
    ...
    public static class PromotionsBean implements Serializable {
        private static final long serialVersionUID = -8000782223329543106L;
        private Object rsn;
        private Object id;
